...
are outputting.
Debugging is arguably the most relavent in terms of what programmers have
to do to help our clients fancy website to run smooth. We debug, and we debug often.
...
In the terminal, type: node A
Well, that what a little too easy. That folder is only 1 letter.
At least, it added our '/' for use
Let's try again and go deeper. 
Now, add the number 2 and *tab again. It should finish out the rest of the file name.
...
//^^write at least 5 logs above this line
